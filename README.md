...
此仓库图片可以通过[云溪院](https://gitee.com/yunxiyuan/gaffe)api接口调用: <br>
`https://api.yunxiyuanyxy.xyz/gaffe/gitee/index.php` <br>
也可通过[justrobot](https://img-api.justrobot.dev/HELPS)的api接口调用: <br>
